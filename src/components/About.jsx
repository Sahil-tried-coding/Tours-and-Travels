  ...
  return (
    ...
    <div className="overflow-x-hidden">
      <div>
       ...
       <p className=" sm:top-[35rem] sm:left-[35rem] sm:text-3xl sm:font-semibold absolute  left-[2.2rem] top-[34rem] text-xl font-semibold  text-nowrap">: Your Ultimate Tours and Travels Guide!</p>
      </div>
